...
static void announce(void)
{
  ...
  printf("\nMINIX %s. "
      ...
      OS_RELEASE);
  printf("MINIX is open source software,  see https://minix3.org\n\n");

  /* Linux 35th Anniversary Tribute Banner with Tux */
  printf("    ___       _     _                  _____ _____   _ _ \n");
  printf("   (o o)     | |   (_)_ __  _   ___  _|___ /| ___ \\ | | |\n");
  printf("  (  V  )    | |   | | '_ \\| | | \\ \\/ / |_ \\| |_/ / | | |\n");
  printf(" /--' '-->   | |___| | | | | |_| |>  < ___) |  __/  |_|_|\n");
  printf("(________)   |_____|_|_| |_|\\__,_/_/\\_\\____/|_|     (_|_)\n");
  printf("               -- Celebrating 35 Years of Linux --       \n\n");
}
