...
void ASTWriter::WriteInputFiles(SourceManager &SourceMgr,
  ...
  Stream.EmitRecordWithBlob(OffsetsAbbrevCode, Record, blobData(InputFileOffsets));
}
...
void ASTWriter::WriteSourceManagerBlock(SourceManager &SourceMgr,
  ...
  Stream.EmitRecordWithBlob(SLocOffsetsAbbrev, Record, blobData(SLocEntryOffsets));
...
void ASTWriter::WritePreprocessorDetail(PreprocessingRecord &PPRec) {
  ...
  if (NumPreprocessingRecords > 0) {
    ...
    Stream.EmitRecordWithBlob(PPEOffsetAbbrev, Record,
                              blobData(PreprocessedEntityOffsets));
  }
}
...
void ASTWriter::WriteCXXBaseSpecifiersOffsets() {
  ...
  Stream.EmitRecordWithBlob(BaseSpecifierOffsetAbbrev, Record,
                            blobData(CXXBaseSpecifiersOffsets));
}
...
uint64_t ASTWriter::WriteDeclContextLexicalBlock(ASTContext &Context,
  ...
  Stream.EmitRecordWithBlob(DeclContextLexicalAbbrev, Record, blobData(Decls));
  return Offset;
}
...
void ASTWriter::WriteTypeDeclOffsets() {
  ...
  Stream.EmitRecordWithBlob(TypeOffsetAbbrev, Record, blobData(TypeOffsets));
  ...
  Stream.EmitRecordWithBlob(DeclOffsetAbbrev, Record, blobData(DeclOffsets));
}
...
void ASTWriter::WriteFileDeclIDsMap() {
  ...
  Stream.EmitRecordWithBlob(AbbrevCode, Record, blobData(FileSortedIDs));
}
